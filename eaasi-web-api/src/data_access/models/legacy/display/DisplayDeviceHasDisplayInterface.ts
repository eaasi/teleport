...
import { DisplayInterface } from '@/data_access/models/legacy/display/DisplayInterface';
...
export class DisplayDeviceHasDisplayInterface extends Model<DisplayDeviceHasDisplayInterface> {
	@CreatedAt
