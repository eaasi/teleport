...
import { NetworkService } from '@/data_access/models/legacy/network/NetworkService';
...
export class ConfiguredNetworkMachineExpectedNetworkService extends Model<ConfiguredNetworkMachineExpectedNetworkService> {
	@CreatedAt
