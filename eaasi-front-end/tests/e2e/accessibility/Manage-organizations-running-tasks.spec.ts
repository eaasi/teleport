...
test('Check accessibility issues into Manage organizations subpage running-tasks', async ({ page }) => {
	...
	await page.goto('https://dev.eaasi.duallab.com:8543/manage-node/running-tasks');
