...
import {configuredMachineInstance, configuredMachineAttribute} from './db';

module.exports = function(sequelize: sequelize.Sequelize, DataTypes: DataTypes) {
  return sequelize.define<configuredMachineInstance, configuredMachineAttribute>('configuredMachine', {
    configuredMachineID: {
